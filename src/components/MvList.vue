    ...
    <el-skeleton :loading="loading" animated :count="num" :throttle="500">
        ...
        <template #default>
            <div class='mv'>
                ...
                <div class="item" :key="uuid() + item.id + index" v-for="(item, index) in mvList">
                    ...
                    <div class="info">
                        ...
                        <div class="mv-playCount"><i class="iconfont icon-mvlist"></i> {{ formartNum(item.playCount) }}
                        </div>
...
import { formartNum, uuid } from '../utils';
const props = defineProps({
    mvList: Array<any>,
    num: Number,
    loading: Boolean
});
const { mvList, num, loading } = props;
</script>
